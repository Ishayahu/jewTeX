...
window.onload = function () {
  ...
  links.forEach(function (target) {
    ...
    target.addEventListener('click', function (e) {
      ...
      elem.innerHTML = '<span class="modal-close">X</span><div class="modal-body"><em>Loading...</em></div>';
      ...
      var body = elem.getElementsByClassName('modal-body')[0];
      ...
      elem.onmousedown = function(e) {
        ...
        if (e.target !== close && e.offsetX < elem.clientWidth) {
